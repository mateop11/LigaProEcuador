...
namespace LigaProEcuador.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public JugadorsController(LigaProEcuadorContext context)
        {
            _context = context;
        }
        ...
        {
            var ligaProEcuadorContext = _context.Jugador.Include(j => j.Equipo);
        ...
        public async Task<IActionResult> Create([Bind("IdJugador,Nombre,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "IdEquipo", "IdEquipo", jugador.IdEquipo);
            return View(jugador);
        }
